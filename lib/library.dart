...
//zakładka z półkami użytkownika
...
//pobranie z bazy półek użytkownika
  Future<void> _loadShelves() async {
    try {
      final storage = FlutterSecureStorage();
      final userId = await storage.read(key: 'user_id'); //pobranie user_id z secure storage
...
//defualtuowe półki, chcemy żeby były wtyświetlane przed customowymi
